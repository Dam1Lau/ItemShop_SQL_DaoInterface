...
public class SQLStatements {
    ...
    public static final String INSERT_customer = "insert into Customers (name, telephone, address) values(?, ?, ?)";
    ...
    public static final String INSERT_user = "insert into Users (username, pass, type, idCustomer) values(?, ?, ?,?)";
    ...
    public static final String DELETE_user_byCustomer = "delete from Users where idCustomer = ?";
